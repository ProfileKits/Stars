...
public abstract class CNBaseFragment extends Fragment {
    ...
    private void dispatchChildVisibleState(boolean visible) {
        ...
        if (null != fragments) {
            for (Fragment fragment : fragments) {
                if (fragment instanceof CNBaseFragment && !fragment.isHidden() && fragment.getUserVisibleHint()) {
                    ((CNBaseFragment) fragment).dispatchUserVisibleHint(visible);
                }
            }
        }
    ...
    private boolean isParentInvisible() {
        ...
        if (parentFragment instanceof CNBaseFragment) {
            CNBaseFragment fragment = (CNBaseFragment) parentFragment;
