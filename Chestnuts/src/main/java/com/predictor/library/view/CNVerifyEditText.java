 ...
 * 验证码EditText View
 */
public class CNVerifyEditText extends LinearLayout {
    //默认 item 个数为 4 个
    ...
    //默认弹出软键盘
    private boolean DEFAULT_SHOW_SOFT_KEYBOARD = true;
    ...
    public CNVerifyEditText(Context context) {
        this(context, null);
    }

    public CNVerifyEditText(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CNVerifyEditText(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context, @Nullable AttributeSet attrs) {
        ...
        DEFAULT_SHOW_SOFT_KEYBOARD = obtainStyledAttributes.getBoolean(R.styleable.verify_EditText_verify_keyboard, true);
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                if (before == 0) {//输入
                    ...
                    if (mInputCompleteListener != null)
                        mInputCompleteListener.uncomplete("");
                }
...
//            textView.setTypeface(Typeface.createFromAsset(context.getAssets(), fontPath));
    ...
    public void addInputCompleteListener(InputCompleteListener inputCompleteListener) {
        ...
        if (!TextUtils.isEmpty(content) && content.toString().length() == mTextViewList.size()) {
            ...
            mInputCompleteListener.uncomplete(content.toString());
        }
    }
    ...
    public interface InputCompleteListener {
        ...
        void uncomplete(String content);
    }
