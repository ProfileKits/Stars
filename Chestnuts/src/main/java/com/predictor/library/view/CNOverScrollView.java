 ...
 */
public class CNOverScrollView extends FrameLayout implements OnTouchListener {
    ...
    public CNOverScrollView(Context context) {
        this(context, null);
    }

    public CNOverScrollView(Context context, AttributeSet attrs) {

        this(context, attrs, 0);
    }

    public CNOverScrollView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void initBounce() {
        ...
        // getInstance the bouncy scroller, and make sure the layout is being drawn
