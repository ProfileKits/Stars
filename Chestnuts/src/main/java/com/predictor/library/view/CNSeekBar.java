...
public class CNSeekBar extends View {
     ...
     * @param context
     */
    public CNSeekBar(Context context, int lineSize, int lineStyle, int lineColorBg, int lineColorProgress, int currentProgress , int maxProgress) {
        super(context);
     ...
     * @param attrs
     */
    public CNSeekBar(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
