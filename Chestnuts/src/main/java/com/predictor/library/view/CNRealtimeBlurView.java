...
/**
 * 使布局中下面的ImageView图片具有磨砂效果
 *
 * 例：<com.sk.weichat.view.RealtimeBlurView
 *    android:layout_width="match_parent"
 *    android:layout_height="226dp"
 *    app:realtimeBlurRadius="90dp"
 *    app:realtimeOverlayColor="@color/transparent_glass" />
 * 实时转换磨砂View
 */
public class CNRealtimeBlurView extends View {
	...
	public CNRealtimeBlurView(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	static {
		try {
			CNRealtimeBlurView.class.getClassLoader().loadClass("android.renderscript.RenderScript");
