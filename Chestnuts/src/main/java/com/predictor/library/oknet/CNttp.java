...
public class CNttp {
    ...
    private volatile static CNttp mInstance;
    private final OkHttpClient mOkHttpClient;
    private final OkHttpExecutor mOkHttpExecutor;

    private CNttp(OkHttpClient okHttpClient) {
     ...
     */
    public static CNttp initClient(OkHttpClient okHttpClient) {
        if (mInstance == null) {
            synchronized (CNttp.class) {
                if (mInstance == null) {
                    mInstance = new CNttp(okHttpClient);
                }
            }
        }
        return mInstance;
     ...
     */
    public static CNttp getInstance() {
