...
public final class CNSPUtils {
    private static SimpleArrayMap<String, CNSPUtils> SP_UTILS_MAP = new SimpleArrayMap<>();
     ...
     * 获取 SP 实例
     *
     * @return {@link CNSPUtils}
     */
    public static CNSPUtils getInstance(Context mcontext) {
     ...
     * @return {@link CNSPUtils}
     */
    public static CNSPUtils getInstance(Context mcontext,String spName) {
        init(mcontext);
        if (isSpace(spName)) spName = "CNSPUtils";
        CNSPUtils CNSPUtils = SP_UTILS_MAP.get(spName);
        if (CNSPUtils == null) {
            CNSPUtils = new CNSPUtils(spName);
            SP_UTILS_MAP.put(spName, CNSPUtils);
        }
        return CNSPUtils;
    }

    private CNSPUtils(final String spName) {
