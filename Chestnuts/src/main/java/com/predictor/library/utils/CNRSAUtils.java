...
import static com.predictor.library.utils.CNDataTypeConverUtils.bytesToHexString;
import static com.predictor.library.utils.CNDataTypeConverUtils.hexStringToBytes;
...
public class CNRSAUtils {
    ...
    public static RSAPrivateKey getRSAPrivateKey(String hexModulus, String hexPrivateExponent) {
        ...
        try {
            modulus = hexStringToBytes(hexModulus);
            privateExponent = hexStringToBytes(hexPrivateExponent);
        } catch (Exception ex) {
    ...
    public static RSAPublicKey getRSAPublicKey(String hexModulus, String hexPublicExponent) {
        ...
        try {
            modulus = hexStringToBytes(hexModulus);
            publicExponent = hexStringToBytes(hexPublicExponent);
        } catch (Exception ex) {
    ...
    public static String encryptString(PublicKey publicKey, String plaintext) {
        ...
        try {
            ...
            return new String(bytesToHexString(en_data));
        } catch (Exception ex) {
            ex.printStackTrace();
        }
        return null;
    ...
    public static String decryptString(PrivateKey privateKey, String encrypttext) {
        ...
        try {
            byte[] en_data = hexStringToBytes(encrypttext);
