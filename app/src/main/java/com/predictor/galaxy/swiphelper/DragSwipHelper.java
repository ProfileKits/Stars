...
public class DragSwipHelper {
    ...
    public  void attachDragRecyclerView(RecyclerView recyclerView, final CNBaseAdapter adapter) {
        int dragFlags = ItemTouchHelper.UP | ItemTouchHelper.DOWN;//拖拽
        attachRecyclerView(recyclerView, adapter, dragFlags, 0);
    }

    public  void attachSwipRecyclerView(RecyclerView recyclerView, final CNBaseAdapter adapter) {
        int swipeFlags = ItemTouchHelper.LEFT | ItemTouchHelper.RIGHT;//侧滑删除
        attachRecyclerView(recyclerView, adapter, 0, swipeFlags);
    }

    public  void attachSwipAndDragRecyclerView(RecyclerView recyclerView, final CNBaseAdapter adapter) {
        int dragFlags = ItemTouchHelper.UP | ItemTouchHelper.DOWN;//拖拽
        int swipeFlags = ItemTouchHelper.LEFT | ItemTouchHelper.RIGHT;//侧滑删除
    ...
    public  void attachRecyclerView(RecyclerView recyclerView, final CNBaseAdapter adapter, final int dragFlags, final int swipeFlags) {
